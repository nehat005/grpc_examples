...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHelloAgain = channel.unary_unary(
                ...
                request_serializer=helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.HelloReplyAgain.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SayHelloAgain': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=helloworld__pb2.HelloRequest.FromString,
                    response_serializer=helloworld__pb2.HelloReplyAgain.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def SayHelloAgain(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/helloworld.Greeter/SayHelloAgain',
            helloworld__pb2.HelloRequest.SerializeToString,
            helloworld__pb2.HelloReplyAgain.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
